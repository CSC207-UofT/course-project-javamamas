...
public class HelloApplication extends Application {
    ...
    public void start(Stage stage) throws IOException {    	
        ...
        Image monopolyMan = new Image(new FileInputStream(currDirectory + "MonopolyMan.gif"));
        ...
        Scene InstructionPage1 = new Scene(group, 1504, 963, MonopolyColor);
        Scene InstructionPage2 = new Scene (group2, 1504, 963, MonopolyColor);
        Scene InstructionPage3 = new Scene (group3, 1504, 963, MonopolyColor);
...
//        stage.setTitle("Instructions Page");
//        stage.setScene(InstructionPage1);
//        stage.show();
    }
